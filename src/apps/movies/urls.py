...
from .views import MovieListView, GenreListView, PersonListView, MovieDetailView, MovieGenresView, PersonMovieView
...
urlpatterns = [
    ...
    path('movies/<int:pk>/genres', MovieDetailView.as_view()),
